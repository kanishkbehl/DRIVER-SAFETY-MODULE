...
# - Accurate fatigue score (based on % eye closure, blink/yawn rate, head-down %)
# - Real-time fatigue score chart using Matplotlib
...
# Fatigue score calculation (accurate version)
...
def update_fatigue_chart(fatigue_score):
...
while True:
    ...
    update_fatigue_chart(fatigue_score)
